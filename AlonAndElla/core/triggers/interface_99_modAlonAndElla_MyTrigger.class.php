...
class InterfaceMytrigger extends DolibarrTriggers
{
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Alon And Ella triggers.";
		// 'development', 'experimental', 'dolibarr' or version
		$this->version = 'development';
		$this->picto = 'mymodule@alonandella';
	}
    ...
    public function billSupplierPayed($action, $object, User $user, Translate $langs, Conf $conf) {
        dol_syslog("A&E trigger '".$this->name."' for action '".$action."' launched by ".__FILE__.". id=".$object->id);
    }
